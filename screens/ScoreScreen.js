      ...
      <ImageBackground source={require('../assets/score.jpg')} style={styles.backgroundImage}>
        <View style={styles.container}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <View style={styles.scoreRow}>
                  <Text style={[styles.score, { color: 'yellow', fontSize: 20 }]}>{item.utilisateur} (Niveau {item.level}): {item.score}</Text>
                </View>
              )}
            />
          )}
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity onPress={this.handleBackHomePress} style={[styles.homeButton, {
